from funkcje import is_palindrome, fibonacci, count_vowels, calculate_discount, flatten_list, word_frequencies, is_prime
import pytest
...
def test_calculate_discount_exceptions():
    with pytest.raises(ValueError):
